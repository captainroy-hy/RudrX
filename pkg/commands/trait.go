...
func AddTraitCommands(parentCmd *cobra.Command, c types.Args, ioStreams util.IOStreams) error {
...
func (o *commandOptions) Run(ctx context.Context, cmd *cobra.Command, io util.IOStreams) error {
	if o.Detach {
