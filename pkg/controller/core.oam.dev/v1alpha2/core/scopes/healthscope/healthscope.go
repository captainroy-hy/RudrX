...
func CUEBasedHealthCheck(ctx context.Context, c client.Client, wlRef runtimev1alpha1.TypedReference, ns string, appfile *af.Appfile) (*WorkloadHealthCondition, []*TraitHealthCondition) {
